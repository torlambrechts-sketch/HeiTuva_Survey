...
import { TuvaSlotProvider } from "@/components/TuvaSlot";
  ...
  return (
    <>
      ...
      {/* One frame for every screen (v1 bundle, HeiTuva.dc.html:364).
          The provider wraps BOTH the page and the helper, because the page is
          what publishes into the slot and the helper is what reads it. */}
      <TuvaSlotProvider>
        <div className="frame pb-16">
          ...
          {/* G4 — TUVA IS SHELL, for F3's reason: v6 draws her wherever the map
            ...
            ends up built in three places and propagated to none. Since G5 she
            renders on EVERY screen; since G6 a screen may replace the panel's
            BODY through `TuvaSlot`, which is how /undersokelser shows svTuva's
            analyst in the one bubble instead of drawing a second one.
