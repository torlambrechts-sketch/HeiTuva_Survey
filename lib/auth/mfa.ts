 ...
 * deferred while there were no customers, re-enabled in Phase 7 because that
 * was the recorded trigger ("before the first real organisation").
 ...
 * screen, and a server action is reachable without ever rendering it. There is
 * no flag in front of it any more (D27): the requirement is unconditional, and
 * turning it off again is a code change that the register has to record.
 */
