...
actively checked** by 5a3, and **26 files / 488 tests** in the census manifest.
...
it 475 → 488 with Q23's schedules RLS (6) and Q20/Q22's recurrence (7). 5a3 is
unmoved by any of them: a CHECK constraint is
