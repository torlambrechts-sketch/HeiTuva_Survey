...
- **Eight handoff bundles, each governing a different question (DECISIONS Q18, extended
  by Q52).** `/design-reference-v7/` (eighth handoff, md5
  `4d8fde3aea0f56e481bfe2416c811f96`, 10558 lines) is the source of truth for every
  screen a **v7 phase touches** — read `project/HeiTuva.dc.html` there before building it.
  ...
  `artifacts/reference-v5/`, `artifacts/reference-v6/` and `artifacts/reference-v7/`.
  ...
  v5's § 0.3d, v6's § 0.3e and **v7's § 0.3f**.
