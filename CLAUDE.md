...
- **Nine handoff bundles, each governing a different question (DECISIONS Q18, extended
  by Q52).** `/design-reference-v8/` (ninth handoff, md5
  `b4e430eccd9cfac0105b8089b6ef206f`, 11050 lines) is the source of truth for every
  screen a **v8 phase touches** — read `project/HeiTuva.dc.html` there before building it.
  **v8's scope is T2's `dashboard` and T3's `surveys` and nothing else**: § 0.3's standing
  rule is that a handoff governs the surfaces its own phases touch, so every other screen
  stays with the bundle it was built from.
  `/design-reference-v7/` (eighth handoff) is the reference for every screen a v7 phase
  built and no v8 phase touches.
  `/design-reference-v6/` (seventh handoff) is the reference for every screen a v6 phase
  built and no v7 phase touches.
  ...
  `artifacts/reference-v5/`, `artifacts/reference-v6/`, `artifacts/reference-v7/` and
  `artifacts/reference-v8/`.
  ...
  v5's § 0.3d, v6's § 0.3e, v7's § 0.3f and **v8's § 0.3g**.
