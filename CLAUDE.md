...
actively checked** by 5a3, and **20 files / 409 tests** in the census manifest.
...
395 → 399 with Q36's four, and 399 → 409 with the policy
panel's ten warning tests. 5a3 is unmoved by either: a CHECK constraint is
